...
namespace SportBattles.Data.Migrations
{
    ...
    [Migration("20210902092405_AddUniqueKeyToPredictions")]
    partial class AddUniqueKeyToPredictions
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SportBattles.Data.Models.GamePointGameType", b =>
                {
                    ...
                    b.HasKey("GamePointId", "GameTypeId");
            ...
            modelBuilder.Entity("SportBattles.Data.Models.Match", b =>
                {
                    ...
                    b.HasIndex("HomeTeamId", "AwayTeamId", "StartTime")
                        .IsUnique();
            ...
            modelBuilder.Entity("SportBattles.Data.Models.Prediction", b =>
                {
                    ...
                    b.HasIndex("UserId", "MatchId", "GameId")
                        .IsUnique();
            ...
            modelBuilder.Entity("SportBattles.Data.Models.TennisMatch", b =>
                {
                    ...
                    b.HasIndex("HomePlayerId", "AwayPlayerId", "StartTime")
                        .IsUnique();
            ...
            modelBuilder.Entity("SportBattles.Data.Models.TennisPrediction", b =>
                {
                    ...
                    b.HasIndex("UserId", "TennisMatchId", "GameId")
                        .IsUnique();
            ...
            modelBuilder.Entity("SportBattles.Data.Models.GamePointGameType", b =>
                {
                    b.HasOne("SportBattles.Data.Models.GamePoint", "GamePoint")
                        .WithMany("GameTypes")
                        .HasForeignKey("GamePointId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
